...
<body>
    ...
    <form id="compose" name="compose" method="post" action="" enctype="multipart/form-data">
        <div class="container mt-5">
            <h2 class="text-center mb-4" style="font-family: 'Poppins', sans-serif; color: black;">Anggota Yang Sering Meminjam Buku</h2>
            <table class="table table-bordered w-80">
                <thead class="table-dark">
                    <tr>
                        <th scope="col">No</th>
                        <th scope="col">Banyak Anggota Yang Sering Meminjam</th>
